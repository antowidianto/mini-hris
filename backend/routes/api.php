...
Route::middleware(['auth:sanctum', 'role:admin,hr'])->group(function () {
    ...
    Route::get('/import-jobs', [ImportExportController::class, 'importJobs']);
    Route::post('/imports/employees', [ImportExportController::class, 'importEmployees']);
    Route::post('/imports/attendance', [ImportExportController::class, 'importAttendance']);
